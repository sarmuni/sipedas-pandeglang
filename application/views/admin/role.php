...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <a href="" class="btn btn-success btn-icon-split btn-sm" data-toggle="modal" data-target="#newRoleModal">
                ...
                <tbody>
                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                                <center>
                                    <a href="<?= base_url('admin/roleaccess/') . $r['id']; ?>" class="btn btn-success btn-icon-split btn-sm">
                                        <span class="icon text-white-50">
                                            <i class="fas fa-flag"></i>
                                        </span>
