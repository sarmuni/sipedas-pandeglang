...
MySQL - 5.5.5-10.4.18-MariaDB : Database - antg9971_sipedas
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`antg9971_sipedas` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;

USE `antg9971_sipedas`;
...
insert  into `anggaran`(`id`,`kode_akun`,`nama_akun`,`tahun_anggaran`,`jan`,`feb`,`mar`,`apr`,`mei`,`jun`,`jul`,`ags`,`sep`,`okt`,`nov`,`des`,`keterangan`,`created_date`,`update_date`,`creted_user`,`update_user`) values (1,'0001','Pemeliharaan Kendaraan Dinas',2022,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,1000000.00,'tes',NULL,NULL,NULL,NULL);
...
insert  into `user`(`id`,`name`,`email`,`image`,`password`,`role_id`,`is_active`,`date_created`) values (5,'Administrator','admin@gmail.com','sarmuni_-_Copy1.jpg','$2y$10$k1BAyFBwb2WYWpO.LOiBaOMcpDOCW8nprZGAFKL/4IuALW/b692DW',1,1,1552120289),(6,'Sarmuni','sarmuni@gmail.com','sarmuni_-_Copy.jpg','$2y$10$k1BAyFBwb2WYWpO.LOiBaOMcpDOCW8nprZGAFKL/4IuALW/b692DW',2,1,1552285263);
